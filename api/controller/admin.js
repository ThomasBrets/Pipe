...
class AdminController {
  ...
  static async promoteAdmins(req, res) {
    const { error, data } = await AdminService.promoteAdmins(
      req.params.userId,
      req.body.admin
    );
  ...
  static async deleteProduct(req, res) {
    const { error, data } = await AdminService.deleteProduct(
      req.params.productId
    );
  ...
  static async getHistoryById(req, res) {
    const { error, data } = await AdminService.getHistoryById(
  ...
  static async getHistoryByUser(req, res) {
    const { error, data } = await AdminService.getHistoryByUser(
      req.params.userId
    );
  ...
  static async getHistoryByProduct(req, res) {
    const { error, data } = await AdminService.getHistoryByProduct(
      req.params.productId
    );
  ...
  static async editCategory(req, res) {
    const { error, data } = await AdminService.editCategory(
      req.params.name,
      req.body
    );
